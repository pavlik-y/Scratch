...
namespace Language.Lua
{
    public partial class Parser
    {
        ...
        {
            var reskey = new Tuple2<int, string>(position, "Assignment");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            if (!success)
            {
                ...
                ParsingResults[reskey] = new Tuple3<object, bool, int>(assignment, success, position);return assignment;
            }
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(assignment, success, position);
            return assignment;
        }

        private Function ParseFunction(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "Function");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(function, success, position);return function;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(function, success, position);
            return function;
        }

        private LocalVar ParseLocalVar(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "LocalVar");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(localVar, success, position);return localVar;
            }
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(localVar, success, position);
            return localVar;
        }

        private LocalFunc ParseLocalFunc(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "LocalFunc");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(localFunc, success, position);return localFunc;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(localFunc, success, position);
            return localFunc;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "IfStmt");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(ifStmt, success, position);return ifStmt;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(ifStmt, success, position);
            return ifStmt;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "ForStmt");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(forStmt, success, position);return forStmt;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(forStmt, success, position);
            return forStmt;
        }

        private ForInStmt ParseForInStmt(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "ForInStmt");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(forInStmt, success, position);return forInStmt;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(forInStmt, success, position);
            return forInStmt;
        }

        private WhileStmt ParseWhileStmt(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "WhileStmt");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(whileStmt, success, position);return whileStmt;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(whileStmt, success, position);
            return whileStmt;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "VarList");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(list_Var, success, position);return list_Var;
            }
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(list_Var, success, position);
            return list_Var;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "FunctionValue");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(functionValue, success, position);return functionValue;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(functionValue, success, position);
            return functionValue;
        }

        private FunctionBody ParseFunctionBody(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "FunctionBody");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(functionBody, success, position);return functionBody;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(functionBody, success, position);
            return functionBody;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "BaseExpr");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            if (success) { ClearError(errorCount); ParsingResults[reskey] = new Tuple3<object, bool, int>(baseExpr, success, position);return baseExpr; }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "KeyAccess");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(keyAccess, success, position);return keyAccess;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(keyAccess, success, position);
            return keyAccess;
        }

        private NameAccess ParseNameAccess(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "NameAccess");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(nameAccess, success, position);return nameAccess;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(nameAccess, success, position);
            return nameAccess;
        }

        private MethodCall ParseMethodCall(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "MethodCall");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(methodCall, success, position);return methodCall;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(methodCall, success, position);
            return methodCall;
        }

        private FunctionCall ParseFunctionCall(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "FunctionCall");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(functionCall, success, position);
            return functionCall;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "FunctionName");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(functionName, success, position);return functionName;
            }
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(functionName, success, position);
            return functionName;
        }

        private GroupExpr ParseGroupExpr(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "GroupExpr");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(groupExpr, success, position);return groupExpr;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(groupExpr, success, position);
            return groupExpr;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "KeyValue");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(keyValue, success, position);return keyValue;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(keyValue, success, position);
            return keyValue;
        }

        private NameValue ParseNameValue(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "NameValue");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(nameValue, success, position);return nameValue;
            }
            ...
            if (success) { ClearError(errorCount); }
            ParsingResults[reskey] = new Tuple3<object, bool, int>(nameValue, success, position);
            return nameValue;
        }

        private ItemValue ParseItemValue(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "ItemValue");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(itemValue, success, position);
            return itemValue;
        }
        ...
        {
            var reskey = new Tuple2<int, string>(position, "FullName");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
            ...
            {
                position = start_position;
                ParsingResults[reskey] = new Tuple3<object, bool, int>(list_string, success, position);return list_string;
            }
            ...
            ParsingResults[reskey] = new Tuple3<object, bool, int>(list_string, success, position);
            return list_string;
        }

        private List<string> ParseNameList(out bool success)
        {
            var reskey = new Tuple2<int, string>(position, "NameList");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
        ...
        {
            var reskey = new Tuple2<int, string>(position, "Name");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
        ...
        {
            var reskey = new Tuple2<int, string>(position, "HexicalNumber");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
        ...
        {
            var reskey = new Tuple2<int, string>(position, "SingleQuotedText");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
        ...
        {
            var reskey = new Tuple2<int, string>(position, "LongString");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
        ...
        {
            var reskey = new Tuple2<int, string>(position, "BinaryOperator");
            if (ParsingResults.ContainsKey(reskey))
            {
                var parsingResult = ParsingResults[reskey];
                success = parsingResult.Item2;
