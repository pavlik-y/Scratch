...
namespace Language.Lua
{
    public partial class Parser
    {
        ...
        public List<Tuple2<int, string>> Errors = new List<Tuple2<int, string>>();
        ...
        /// </summary>
        private Dictionary<Tuple2<int, string>, Tuple3<object, bool, int>> ParsingResults = new Dictionary<Tuple2<int, string>, Tuple3<object, bool, int>>();
        ...
        {
            Errors.Add(new Tuple2<int, string>(position, message));
            return Errors.Count;
        }
        ...
        public string GetEorrorMessages()
        {
            ...
            foreach (Tuple2<int, string> msg in Errors)
            {
